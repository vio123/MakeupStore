...
class CartProductAdapter(
    private var data: List<CartProduct>,
    private val listener: OnItemClickListener,
) : RecyclerView.Adapter<CartProductAdapter.MyViewHolder>() {

    inner class MyViewHolder(private val itemBinding: CartProductBinding) :
        ...
        fun bind(item: CartProduct) {
            ...
            itemBinding.prodCant.addTextChangedListener(object : TextWatcher {
                ...
                override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
                    try {
                        itemBinding.prodPrice.text =
                            String.format("%.2f", p0.toString().toInt() * item.price.toDouble())
            ...
            itemBinding.prodPrice.text =
                String.format("%.2f", item.quantity * item.price.toDouble())
